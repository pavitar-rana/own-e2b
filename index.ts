...
import { createFireCracker, deleteFireCracker } from "./index-stateful.ts";
import { attemptSSHConnection } from "./lib/connectSsh.ts";
import { createDir, runCommand, writeFile } from "./runCommand.ts";
import { prisma } from "./lib/prisma.ts";
import cors from "cors";
import { VM_TO_HOST_PORT } from "./constants.ts";
...
app.post("/run", async (req, res) => {
    ...
    const finalPath = typeof path === "string" && path.trim() !== "" ? path : `/root/${projectId}/`;
